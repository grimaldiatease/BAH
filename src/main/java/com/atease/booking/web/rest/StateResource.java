...
import com.atease.booking.repository.StateRepository;
import com.atease.booking.service.StateService;
...
/**
 * REST controller for managing {@link com.atease.booking.domain.State}.
 */
@RestController
@RequestMapping("/api")
public class StateResource {
    ...
    private static final String ENTITY_NAME = "bookingserviceState";
