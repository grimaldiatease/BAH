...
import com.atease.booking.repository.CityRepository;
import com.atease.booking.service.dto.CityDTO;
import com.atease.booking.service.mapper.CityMapper;
...
class CityResourceIT {
    ...
    public static City createEntity(EntityManager em) {
        City city = new City().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return city;
    }
    ...
    public static City createUpdatedEntity(EntityManager em) {
        City city = new City().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return city;
    }
    ...
    void putExistingCity() throws Exception {
        ...
        updatedCity.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCityWithPatch() throws Exception {
        ...
        partialUpdatedCity.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
